  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-4 lg:grid-cols-3">
        {[
          { label: "Content Types", value: contentTypes.length, href: "/content-types" },
          { label: "Media Assets", value: media.length, href: "/media" },
          { label: "Active Users", value: users.length, href: "/users" },
        ].map((card) => (
          ...
          <CardContent className="space-y-3">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {type.apiId} - {type.fields?.length ?? 0} fields
                  </p>
                </div>
            ...
            {contentTypes.length === 0 && (
              <div className="rounded-xl border border-dashed border-border/60 px-4 py-6 text-sm text-muted-foreground">
                No content types yet. Start by creating your first collection.
              </div>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="glass-panel">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2 rounded-xl bg-background/70 p-4">
              <p className="text-sm font-semibold">Create a content type</p>
              <p className="text-xs text-muted-foreground">
                Define fields and relations before capturing entries.
              </p>
            ...
            <div className="space-y-2 rounded-xl bg-background/70 p-4">
              <p className="text-sm font-semibold">Upload new assets</p>
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2 rounded-xl bg-background/70 p-4">
              <p className="text-sm font-semibold">Lock down permissions</p>
              <p className="text-xs text-muted-foreground">
