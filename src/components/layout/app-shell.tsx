...
export function AppShell({ children }: { children: React.ReactNode }) {
	...
	useEffect(() => {
		...
		return () =>
			window.removeEventListener("apiforge:content-types", handler);
	}, [loadContentTypes]);
	...
	useEffect(() => {
		...
		window.addEventListener("apiforge:unauthorized", handler);
		return () =>
			window.removeEventListener("apiforge:unauthorized", handler);
	}, [router]);
